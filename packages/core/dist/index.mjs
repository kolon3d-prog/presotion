...
var PresentationContext = createContext2(null);
function usePresentationContext() {
  const context = useContext2(PresentationContext);
  if (!context) {
    throw new Error(
...
function Slide({
  ...
  const content = /* @__PURE__ */ jsx2(SlideContext.Provider, { value: contextValue, children });
  if (layout === "none") {
    return /* @__PURE__ */ jsx2(Fragment, { children: content });
  }
  return /* @__PURE__ */ jsx2(AbsoluteFill, { className, style, "data-slide": from, "data-slide-name": name, children: content });
}
...
var DeckBase = ({ children, startFrom = 0 }) => {
  ...
  return /* @__PURE__ */ jsx3(
    AbsoluteFill,
    {
      ...
      children: /* @__PURE__ */ jsx3(SlideContext.Provider, { value: contextValue, children: props.children })
    }
  );
};
var Deck = DeckBase;
...
function Fragment4({
  ...
  if (animation === "none") {
    return isVisible ? /* @__PURE__ */ jsx4(Fragment3, { children }) : null;
  }
  let animationStyle = {};
  switch (animation) {
    case "fade":
  ...
  return /* @__PURE__ */ jsx4("div", { style: { ...animationStyle, willChange: "opacity, transform" }, children });
}
function FragmentList({
  ...
  return /* @__PURE__ */ jsx4(Fragment3, { children: childArray.map((child, index) => /* @__PURE__ */ jsx4(
    Fragment4,
    {
      at: startAt + index,
      animation,
...
import { useState, useCallback, useMemo as useMemo3, useEffect } from "react";
...
function Presentation({
  ...
  const [fragmentCounts, setFragmentCounts] = useState([]);
  ...
  const registerFragmentCount = useCallback((slideIndex, count) => {
  ...
  return /* @__PURE__ */ jsx5(PresentationContext.Provider, { value: contextValue, children: /* @__PURE__ */ jsx5(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsx5(Component, { ...resolvedProps })
    }
  ) });
}

// src/components/Img.tsx
import { forwardRef as forwardRef2, useState as useState2, useEffect as useEffect2 } from "react";
...
var Img = forwardRef2(
  ({ src, placeholder, style, ...props }, ref) => {
    ...
    if (!loaded && placeholder) {
      return /* @__PURE__ */ jsx6(Fragment5, { children: placeholder });
    }
    return /* @__PURE__ */ jsx6(
      "img",
      {
